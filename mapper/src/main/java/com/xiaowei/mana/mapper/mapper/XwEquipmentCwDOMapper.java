 ...
 * 饮用水设备表
 */
public interface XwEquipmentCwDOMapper{
     ...
     * @return int
     */
    int insert(XwEquipmentCwDO entity);
    /**
     ...
     * @return int
     */
    int update(XwEquipmentCwDO entity);
    /**
     ...
     */
    XwEquipmentCwDO getById(Long id);
    /**
     ...
     * @return XwEquipmentCwDO
     */
    XwEquipmentCwDO saveCw(XwEquipmentCwDO entity);
    /**
     * desc:更新引用水设备.<br/>
     ...
     * @return int
     */
    int updateCw(XwEquipmentCwDO entity);
    /**
     ...
     * @return XwEquipmentCwDO
     */
    XwEquipmentCwDO feignCWbyDeviceNo(String deviceNo);
    /**
     * desc:更新引用水推送状态.<br/>
     ...
     * @return int
     */
    int updatePush(XwEquipmentCwDO entity);
}
