...
import com.xiaowei.mana.mapper.mapper.ParameterConfigurationDOMapper;
...
public class ParameterConfigurationDAO{
    ...
    @Autowired
    private ParameterConfigurationDOMapper parameterConfigurationDOMapper;
     ...
     * @return int
     */
    public int insert(ParameterConfigurationDO entity){
        return parameterConfigurationDOMapper.insert(entity);
    }
    /**
     ...
     * @return int
     */
    public int update(ParameterConfigurationDO entity){
        return parameterConfigurationDOMapper.update(entity);
    }
    /**
    ...
    public int deleteById(Long id){
        return parameterConfigurationDOMapper.deleteById(id);
    }
    /**
     ...
     */
    public ParameterConfigurationDO getById(Long id){
        return parameterConfigurationDOMapper.getById(id);
    }
    /**
     ...
     * @return Integer
     */
    public Integer getCountFieldValue(ParameterConfigurationDO entity){
        return parameterConfigurationDOMapper.getCountFieldValue(entity);
    }
    /**
     * desc:更新表:sys_parameter_configuration.<br/>
     ...
     * @return ParameterConfigurationDO
     */
    public ParameterConfigurationDO interParameter(ParameterConfigurationDO entity){
        return parameterConfigurationDOMapper.interParameter(entity);
    }
    /**
     * desc:查询已存在的数量.<br/>
     ...
     */
    public List<ParameterConfigurationDO> getCountsByName(String parameterName){
        return parameterConfigurationDOMapper.getCountsByName(parameterName);
    }
    /**
     ...
     * @return List<ParameterConfigurationDO>
     */
    public List<ParameterConfigurationDO> getParameterInfoByFieldValue(Long dictionaryId){
        return parameterConfigurationDOMapper.getParameterInfoByFieldValue(dictionaryId);
    }
    /**
     * desc:更新参数表.<br/>
     ...
     * @return int
     */
    public int updateParameter(ParameterConfigurationDO entity){
        return parameterConfigurationDOMapper.updateParameter(entity);
    }
    /**
     ...
     * @return ParameterConfigurationDO
     */
    public ParameterConfigurationDO getByUuid(String sysParameterUuid){
        return parameterConfigurationDOMapper.getByUuid(sysParameterUuid);
    }
    /**
     ...
     * @return List<ParameterConfigurationDO>
     */
    public List<ParameterConfigurationDO> getEditCountsByName(Long id,String parameterName){
        return parameterConfigurationDOMapper.getEditCountsByName(id, parameterName);
    }
}
