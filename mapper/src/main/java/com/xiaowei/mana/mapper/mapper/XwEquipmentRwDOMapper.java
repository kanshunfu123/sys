 ...
 * 河道水设备
 */
public interface XwEquipmentRwDOMapper{
     ...
     * @return int
     */
    int insert(XwEquipmentRwDO entity);
    /**
     ...
     * @return int
     */
    int update(XwEquipmentRwDO entity);
    /**
     ...
     */
    XwEquipmentRwDO getById(Long id);
    /**
     ...
     * @return int
     */
    int insertRw(XwEquipmentRwDO entity);
    /**
     * desc:更新井盖设备.<br/>
     ...
     * @return int
     */
    int updateRw(XwEquipmentRwDO entity);
    /**
     ...
     * @return XwEquipmentRwDO
     */
    XwEquipmentRwDO feignRWbyDeviceNo(String deviceNo);
    /**
     * desc:更新井盖推送状态.<br/>
     ...
     * @return int
     */
    int updatePush(XwEquipmentRwDO entity);
}
