...
import com.xiaowei.mana.mapper.mapper.RoleAclDOMapper;
...
public class RoleAclDAO{
     ...
     * descSql =  SELECT LAST_INSERT_ID() INSERT INTO SYS_ROLE_ACL( GROUP_ID ,SYS_ACL_ID ,SYS_ROLE_ID ,DEL_FLAG ,CREATE_BY ,UPDATE_BY ,SYS_ROLE_ACL_UUID ,SYS_ACL_PERMISSION_TYPE ,CREATE_TIME ,UPDATE_TIME )VALUES( #{groupId,jdbcType=BIGINT} ,#{sysAclId,jdbcType=BIGINT} ,#{sysRoleId,jdbcType=BIGINT} ,#{delFlag,jdbcType=CHAR} ,#{createBy,jdbcType=VARCHAR} ,#{updateBy,jdbcType=VARCHAR} ,#{sysRoleAclUuid,jdbcType=VARCHAR} ,#{sysAclPermissionType,jdbcType=CHAR} ,#{createTime,jdbcType=TIMESTAMP} ,#{updateTime,jdbcType=TIMESTAMP} )
     * @param entity entity
     * @return int
     */
     ...
     * descSql =  UPDATE SYS_ROLE_ACL SET GROUP_ID = #{groupId,jdbcType=BIGINT} ,SYS_ACL_ID = #{sysAclId,jdbcType=BIGINT} ,SYS_ROLE_ID = #{sysRoleId,jdbcType=BIGINT} ,DEL_FLAG = #{delFlag,jdbcType=CHAR} ,CREATE_BY = #{createBy,jdbcType=VARCHAR} ,UPDATE_BY = #{updateBy,jdbcType=VARCHAR} ,SYS_ROLE_ACL_UUID = #{sysRoleAclUuid,jdbcType=VARCHAR} ,SYS_ACL_PERMISSION_TYPE = #{sysAclPermissionType,jdbcType=CHAR} ,CREATE_TIME = #{createTime,jdbcType=TIMESTAMP} ,UPDATE_TIME = #{updateTime,jdbcType=TIMESTAMP} WHERE ID = #{id,jdbcType=BIGINT}
     * @param entity entity
     * @return int
     */
