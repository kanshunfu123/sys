...
import com.xiaowei.mana.mapper.mapper.DeptDOMapper;
...
public class DeptDAO{
     ...
     * descSql =  SELECT LAST_INSERT_ID() INSERT INTO SYS_DEPT( GROUP_ID ,SYS_DEPT_PARENT_ID ,DEL_FLAG ,CREATE_BY ,UPDATE_BY ,SYS_IS_LEAF ,SYS_DEPT_NAME ,SYS_DEPT_UUID ,SYS_DEPT_LEVEL ,SYS_DEPT_REMARK ,SYS_DEPT_SEQ ,CREATE_TIME ,UPDATE_TIME )VALUES( #{groupId,jdbcType=BIGINT} ,#{sysDeptParentId,jdbcType=BIGINT} ,#{delFlag,jdbcType=CHAR} ,#{createBy,jdbcType=VARCHAR} ,#{updateBy,jdbcType=VARCHAR} ,#{sysIsLeaf,jdbcType=CHAR} ,#{sysDeptName,jdbcType=VARCHAR} ,#{sysDeptUuid,jdbcType=VARCHAR} ,#{sysDeptLevel,jdbcType=VARCHAR} ,#{sysDeptRemark,jdbcType=VARCHAR} ,#{sysDeptSeq,jdbcType=INTEGER} ,#{createTime,jdbcType=TIMESTAMP} ,#{updateTime,jdbcType=TIMESTAMP} )
     * @param entity entity
     * @return int
     */
