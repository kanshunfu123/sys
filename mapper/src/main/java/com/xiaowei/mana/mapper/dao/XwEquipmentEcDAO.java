...
import com.xiaowei.mana.mapper.mapper.XwEquipmentEcDOMapper;
...
*/
@Repository
public class XwEquipmentEcDAO{

    @Autowired
    private XwEquipmentEcDOMapper xwEquipmentEcDOMapper;
     ...
     * @return int
     */
    public int insert(XwEquipmentEcDO entity){
        return xwEquipmentEcDOMapper.insert(entity);
    }
    /**
     ...
     * @return int
     */
    public int update(XwEquipmentEcDO entity){
        return xwEquipmentEcDOMapper.update(entity);
    }
    /**
    ...
    public int deleteById(Long id){
        return xwEquipmentEcDOMapper.deleteById(id);
    }
    /**
     ...
     */
    public XwEquipmentEcDO getById(Long id){
        return xwEquipmentEcDOMapper.getById(id);
    }
    /**
     * desc:插入表:XW_EQUIPMENT_EC.<br/>
     ...
     * @return int
     */
    public int insertEc(XwEquipmentEcDO entity){
        return xwEquipmentEcDOMapper.insertEc(entity);
    }
    /**
     * desc:更新电梯设备.<br/>
     ...
     * @return int
     */
    public int updateEc(XwEquipmentEcDO entity){
        return xwEquipmentEcDOMapper.updateEc(entity);
    }
    /**
     * desc:更新电梯推送状态.<br/>
     ...
     * @return int
     */
    public int updatePush(XwEquipmentEcDO entity){
        return xwEquipmentEcDOMapper.updatePush(entity);
    }
}
