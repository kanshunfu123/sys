package com.xiaowei.mana.mapper.config;
...
public class DataSourceConfig {
     ...
     */
    private static String MAPPER_PATH = "/com/xiaowei/mana/mapper/**/*.xml";
    private static String TYPE_ALIASES_Package = "com.xiaowei.mana.mapper.dataobject";
    static final String PACKAGE = "com.xiaowei.mana.mapper.mapper";
    @Autowired
