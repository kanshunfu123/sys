 ...
 * 电梯场景表
 */
public interface XwEcSenceDOMapper{
     ...
     * @return int
     */
    int insertEcSence(XwEcSenceDO entity);
    /**
     * desc:更新电梯场景信息.<br/>
     ...
     * @return int
     */
    int updateEcSence(XwEcSenceDO entity);
    /**
     ...
     * @return Integer
     */
    Integer getElevatorCode(XwEcSenceDO entity);
    /**
     * desc:根据 电梯编码 全局唯一.<br/>
     ...
     * @return Integer
     */
    Integer getEditElevatorCode(XwEcSenceDO entity);
    /**
     ...
     */
    List<XwEcSenceDO> getEditCountsByCode(@Param("deviceNo")String deviceNo,@Param("elevatorCode")String elevatorCode);
}
