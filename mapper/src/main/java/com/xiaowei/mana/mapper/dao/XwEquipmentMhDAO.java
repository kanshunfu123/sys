...
import com.xiaowei.mana.mapper.mapper.XwEquipmentMhDOMapper;
...
*/
@Repository
public class XwEquipmentMhDAO{

    @Autowired
    private XwEquipmentMhDOMapper xwEquipmentMhDOMapper;
     ...
     * @return int
     */
    public int insert(XwEquipmentMhDO entity){
        return xwEquipmentMhDOMapper.insert(entity);
    }
    /**
     ...
     * @return int
     */
    public int update(XwEquipmentMhDO entity){
        return xwEquipmentMhDOMapper.update(entity);
    }
    /**
    ...
    public int deleteById(Long id){
        return xwEquipmentMhDOMapper.deleteById(id);
    }
    /**
     ...
     */
    public XwEquipmentMhDO getById(Long id){
        return xwEquipmentMhDOMapper.getById(id);
    }
    /**
     ...
     * @return int
     */
    public int insertMh(XwEquipmentMhDO entity){
        return xwEquipmentMhDOMapper.insertMh(entity);
    }
    /**
     * desc:更新井盖设备.<br/>
     ...
     * @return int
     */
    public int updateMh(XwEquipmentMhDO entity){
        return xwEquipmentMhDOMapper.updateMh(entity);
    }
    /**
     ...
     * @return XwEquipmentMhDO
     */
    public XwEquipmentMhDO feignMHbyDeviceNo(String deviceNo){
        return xwEquipmentMhDOMapper.feignMHbyDeviceNo(deviceNo);
    }
    /**
     * desc:更新井盖推送状态.<br/>
     ...
     * @return int
     */
    public int updatePush(XwEquipmentMhDO entity){
        return xwEquipmentMhDOMapper.updatePush(entity);
    }
}
