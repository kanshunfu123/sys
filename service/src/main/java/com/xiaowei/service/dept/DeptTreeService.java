...
import com.xiaowei.common.res.dept.DeptLevelDto;
...
public class DeptTreeService {
     ...
     * @return
     */
    public JSONResult deptTree(RedisUser redisUser) {
        List<DeptDO> deptList = deptMapper.deptTree(redisUser.getGroupId());
        ...
        return JSONResult.ok(deptLevelDtos);
    }
