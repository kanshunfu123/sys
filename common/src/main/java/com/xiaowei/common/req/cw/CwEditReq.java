...
@AllArgsConstructor
@ToString
public class CwEditReq extends BaseReq implements Serializable {
    /**
     * id 主键.
     */
    private Long id;
     ...
     * areaId 区id.
     */
    @NotNull(message = "areaId 区id必填",groups = {BaseReq.Add.class, BaseReq.Modify.class})
    private Long areaId;
    /**
     * cityId 市id.
     */
    @NotNull(message = "cityId 市id必填",groups = {BaseReq.Add.class, BaseReq.Modify.class})
    private Long cityId;
    /**
     * villageId VILLAGE_ID.
     */
    @NotNull(message = "villageId 小区id必填",groups = {BaseReq.Add.class, BaseReq.Modify.class})
    private Long villageId;
    /**
     * provinceId 省id.
     */
    @NotNull(message = "provinceId 省id必填",groups = {BaseReq.Add.class, BaseReq.Modify.class})
     ...
     */
    @NotBlank(message = "deviceCode 编号必填",groups = {BaseReq.Add.class, BaseReq.Modify.class})
     ...
     * deviceName 设备名称.
     */
    @NotBlank(message = "deviceName 设备名称必填",groups = {BaseReq.Add.class, BaseReq.Modify.class})
