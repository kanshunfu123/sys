...
@AllArgsConstructor
@ToString
public class EcSenceAddReq extends BaseReq implements Serializable {
    /**
     * id 主键.
     */
    private Long id;
     ...
     * ecBrand 电梯品牌.
     */
    @NotBlank(message = "ecBrand 电梯品牌",groups = {Add.class,Modify.class})
    private String ecBrand;
    /**
     * yearsOfUser 电梯使用年限.
     */
    @NotNull(message = "yearsOfUser 电梯使用年限必填",groups = {Add.class,Modify.class})
