...
@AllArgsConstructor
@ToString
public class MhSenceAddReq extends BaseReq implements Serializable {
    /**
     * id ID.
     */
    private Long id;
     ...
     * mhMaterial 井盖材质.
     */
    @NotBlank(message = "mhMaterial 井盖材质",groups = {Add.class,Modify.class})
     ...
     * mhYears 使用年限.
     */
    @NotNull(message = "mhYears 使用年限必填",groups = {Add.class,Modify.class})
     ...
     * mhDiameter 井盖直径.
     */
    @NotBlank(message = "mhDiameter 井盖直径",groups = {Add.class,Modify.class})
    private String mhDiameter;
    /**
     * mhType 井盖使用类型.
     */
    @NotBlank(message = "mhType 井盖使用类型",groups = {Add.class,Modify.class})
