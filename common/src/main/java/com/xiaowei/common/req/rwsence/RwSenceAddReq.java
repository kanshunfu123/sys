...
@AllArgsConstructor
@ToString
public class RwSenceAddReq extends BaseReq implements Serializable {
    /**
     * id 主键.
     */
    private Long id;
     ...
     * rwType 河道使用类型.
     */
    @NotBlank(message = "rwGrade 河道等级",groups = {Add.class,Modify.class})
     ...
     */
    @NotNull(message = "rwGrade 河道等级",groups = {Add.class,Modify.class})
