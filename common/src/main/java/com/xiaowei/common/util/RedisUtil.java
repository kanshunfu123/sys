package com.xiaowei.common.util;
...
public class RedisUtil {
    ...
    public boolean set(String key, Object value, long time) {
        try {
            ...
            logger.error("redis set time error:{}===={}" + e.getMessage(), e);
            return false;
        }
    }
     ...
     * @return 值
     */
    public Object hgetMapKeys(String key, List<Object> item) {
    ...
    public boolean hmset(String key, Map<String, Object> map) {
        try {
            ...
            e.printStackTrace();
            logger.error("对应多个键值:{}===={}" + e.getMessage(), e);
            return false;
        }
    }
